...
The bar plots and @tbl-good-habits-correlation summarize how each lifestyle habit correlates with academic performance. The colors in the plots indicate whether a habit *helps* (positive correlation) or *hurts* (negative correlation) exam scores.
