...
@fig-blue below illustrates the correlation among good habits and exam score. Circle size and color represent the strength and direction of correlation, with stronger positive values shown in blue and negative in red.

```{r}
#| echo: false
#| warning: false
#| label: fig-blue
#| fig-cap: 'Blue = positive, red = negative, size shows strength'
...
-   @fig-bubble shows how three good habits relate to student exam scores:
...
-   @fig-bubble-style how two bad habits relate to exam performance:
...
#| echo: false
#| warning: false
#| label: fig-bubble-style
#| fig-cap: "Bubble-style correlation matrix of bad habits and exam score"
...
@tbl-relationship shows that `StudyHours` has a strong positive relationship with `ExamScore` (r = 0.83), making it the most significant factor influencing academic success. `AttendanceRate` (r = 0.09) and `SleepHours` (r = 0.12) show weak positive associations, suggesting minor contributions.
...
#| echo: false
#| warning: false
#| label: tbl-relationship
#| tbl-cap: "Relationship between lifestyle habits and academic performance"
