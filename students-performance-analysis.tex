...
\lfoot{\sf Malaika, Kunal, ZuxiLu: 31 May 2025}
\begin{document}
\maketitle
...
Figure~\ref{fig-correlation-with-exam-score} shows a bar plot of how
good and bad habits correlate with exam scores. Bars are color-coded to
indicate positive (``Helps'') or negative (``Hurts'') impact.

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{students-performance-analysis_files/figure-pdf/fig-correlation-with-exam-score-1.pdf}}

}

\caption{\label{fig-correlation-with-exam-score}Correlation with exam
score}
...
\begin{itemize}
\item
  Figure~\ref{fig-how} summarizes how StudyHours, AttendanceRate, and
  SleepHours relate to exam scores using a labeled bar plot.
\item
...
\pandocbounded{\includegraphics[keepaspectratio]{students-performance-analysis_files/figure-pdf/fig-how-1.pdf}}

}

\caption{\label{fig-how}How Habits Correlate with Exam Performance}
...
\begin{itemize}
\item
  Figure~\ref{fig-how-bad} shows how two bad habits relate to exam
  performance:
...
\pandocbounded{\includegraphics[keepaspectratio]{students-performance-analysis_files/figure-pdf/fig-how-bad-1.pdf}}

}

\caption{\label{fig-how-bad}How Bad Habits Correlate with Exam
Performance}
