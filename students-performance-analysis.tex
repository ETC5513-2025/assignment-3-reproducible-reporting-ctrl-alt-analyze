...
\lfoot{\sf Malaika, Kunal, ZuxiLu: 27 May 2025}
\begin{document}
\maketitle
...
Figure \textbf{1} below illustrates the correlation among good habits
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{students-performance-analysis_files/figure-pdf/Correlation among habits-1.pdf}}

}

\caption{Blue = positive, red = negative, size shows strength}
...
\caption{Bubble-style correlation matrix of bad habits and exam score}
